    ...
    <div id="cuerpo">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="../imagenes/atenas/atenas1.jpg" alt="Fotografía de acrópolis">
            <div class="carousel-caption d-md-block">
              <h1>Vive Atenas</h1>
              <h2 class="d-none d-md-block">La historia de la acrópolis</h2>
            </div>
          </div>
          <!--Elemento del carrusel: Imagen, y sus textos-->
          <div class="carousel-item">
            <img class="d-block w-100" src="../imagenes/atenas/atenas2.jpg" alt="Fotografía anfiteatro">
            <div class="carousel-caption d-md-block">
              <h1>Disfruta Atenas</h1>
              <h2 class="d-none d-md-block">Sus monumentos</h2>
            </div>
          </div>
          <!--Elemento del carrusel: Imagen, y sus textos-->
          <div class="carousel-item">
            <img class="d-block w-100" src="../imagenes/atenas/atenas3.jpg" alt="Fotografía templo de Zeus">
            <div class="carousel-caption d-md-block">
              <h1>Sueña en Atenas</h1>
              <h2 class="d-none d-md-block">Sientente como un dios</h2>
            </div>
          </div>
          <!--Elemento del carrusel: Imagen, y sus textos-->
          <div class="carousel-item">
            <img class="d-block w-100" src="../imagenes/atenas/atenas4.jpg" alt="Fotografía ensalada griega">
            <div class="carousel-caption d-md-block">
              <h1>Comete Atenas</h1>
              <h2 class="d-none d-md-block">Gastronomía mediterránea</h2>
            </div>
          </div>
        </div>
        <!--controles-->
      ...
      <div class="container-fluid">
        <!--Nombre del hotel-->
        <div id="titulo">
          <h3 class="text-center">Modern Palace Atenas</h3>
          <hr>
          <!--Información-->
          <div class="row info">
            <!--Información del Destino/Hotel-->
            <div class="col-12 col-md-3">
              <h4 class="text-center">Atenas histórica  <img class="enlacesBlack" src="../imagenes/mundo.png" alt="Icono mundo"></h4>
              <p>Visita Atenas, la ciudad de los antiguos dioses del Olimpo, una de las capitales más antiguas del mundo, cuna de la civilización occidenta.
                Deleitate con sus monumentos y disfruta de su gastronomía. Nuestro hotel se encuentra en el centro histórico por lo que tendrás acceso a los
                lugares más importantes y a gran cantidad de medios de transporte públicos que te permitiran moverte por la ciudad.</p>
            </div>
        ...
        <div class="destacar info">
          ...
          <form action="../controlador/control.php" method="post">
            ...
            <input type="hidden" id="ciudad" name="destino" value="Atenas,GR">
            <div class="form-row justify-content-center">
              ...
              <!--Selección de una 2ª habitación-->
              <div class="col-md-2 col-sm-6">
                <label for="habitacion">Añadir 2ª Habitación</label>
            ...
            <!--Checks para seleccionar tipo de habitación y regimen -->
              <div class="form-check">
                ...
                <label class="form-check-label" for="Radios1">
                  Alojamiento con Desayuno Buffet incluido. <strong>Precio por noche: 55 €*</strong>
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input simple" type="radio" name="regimen" id="Radios2" value="simpleMedia">
                <label class="form-check-label" for="Radios2">
                  Alojamiento en régimen de Media Pensión (Desayuno y Cena Buffet). <strong>Precio por noche: 85 €*</strong>
                </label>
              </div>
        </div>
      </div>
          ...
          <p>Habitaciones dobles, tranquilas y funcionales para disfrutar en la mejor compañia, equipadas y diseñadas para garantizar el máximo confort.
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="Radios3">
                Alojamiento con Desayuno Buffet incluido. <strong>Precio por noche: 125 €*</strong>
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input doble" type="radio" name="regimen" id="Radios4" value="dobleMedia">
              <label class="form-check-label" for="Radios4">
                Alojamiento en régimen de Media Pensión (Desayuno y Cena Buffet). <strong>Precio por noche: 185 €*</strong>
              </label>
            </div>
        </div>
      </div>
