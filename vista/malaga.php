      ...
      <div class="container-fluid">
        ...
        <div class="destacar info">
          ...
          <form action="../controlador/control.php" method="post">
            ...
            <input type="hidden" id="ciudad" name="destino" value="Malaga,ES">
    ...
    <footer>
      <div id = "pie">
        <div class="row m-4 p-3 align-items-start">
          <!--Logotipo-->
            <a class="col-md-2 col-8 d-block w-100 m-auto order-md-1 order-2" href="#cuerpo"><img src="../imagenes/logo.png" id="logopie" alt="logotipo fin página, click para ir arriba"></a>
